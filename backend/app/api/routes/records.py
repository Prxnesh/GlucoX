...
from app.schemas.record import ClearHistoryResponse, DashboardResponse
from app.services.auth_service import get_current_user
from app.services.history_service import build_dashboard_snapshot, clear_dashboard_history
...
async def clear_history(user: CurrentUser = Depends(get_current_user)):
    return await clear_dashboard_history(user.id)
