...
SCHEMA_PATH = Path('/Users/pranesh/Devloper/diabetes prediction/HealthSense/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/pranesh/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    healthrecord: 'actions.HealthRecordActions[models.HealthRecord]'
    reportextraction: 'actions.ReportExtractionActions[models.ReportExtraction]'
    ...
    def __init__(
        ...
        *,
        ...
        self.healthrecord = actions.HealthRecordActions[models.HealthRecord](self, models.HealthRecord)
        self.reportextraction = actions.ReportExtractionActions[models.ReportExtraction](self, models.ReportExtraction)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/pranesh/Devloper/diabetes prediction/HealthSense/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    healthrecord: 'HealthRecordBatchActions'
    reportextraction: 'ReportExtractionBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.healthrecord = HealthRecordBatchActions(self)
        self.reportextraction = ReportExtractionBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class HealthRecordBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class ReportExtractionBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
